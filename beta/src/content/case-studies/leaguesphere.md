...
whatWeDid: |
  ...
  <p class="phase-label"><strong>Build Phase (2021–2022):</strong></p>
  <ul>
    <li>Deep understanding of league operations and workflows</li>
    <li>MVP focused on the core pain: scheduling + official assignment + results publication</li>
    <li>Iterative development with real leagues using it</li>
    <li>Team adoption support from day one (not after launch)</li>
  </ul>
  <p class="phase-label"><strong>Scale Phase (2022–2024):</strong></p>
  <ul>
    <li>Feature expansion based on league feedback</li>
    <li>Multi-region deployment (6+ leagues onboarded)</li>
    <li>Digital pass system, advanced reporting, integration capabilities</li>
    <li>Team training and process adoption (the hard part)</li>
  </ul>
...
But vision without execution is just a wish. They needed:
- Software that actually understood league operations (not generic project management tool)
- A team that would stick with them through the messy middle when adoption seemed impossible
- Partners who wouldn't just hand over code and disappear
- Confidence that the product would grow with them
