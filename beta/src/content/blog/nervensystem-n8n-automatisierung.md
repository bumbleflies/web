...
Die prägende Entscheidung dieser Säule: Für jeden nicht-trivialen Workflow ist die exportierte Konfiguration zwar die Quelle der Wahrheit, aber sie wird nicht von Hand geschrieben. Ein kleines Python-Skript *erzeugt* sie.
